...
<head>
	...
	<?php
	$title = "Sobre Nosotros - SearchOut";
	?>
	...
	<div id="content">
		<svg id="take-back-control" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 180 40">
            ...
            <text fill="url(#grad1)" text-anchor="middle" x="50%" y="25%" id="principal-text">
                <tspan x="50%" dy="0">Busca más rápido con</tspan>
        ...
        <div id="how-work2">
        	<h1 style="display: inline;" id="title42"><p style="color: #4c54d2; display: inline;">¿Por qué?</p></h1>
        	<p id="text42">Creemos que las personas merecen una nueva y mejor forma de buscar. Por eso hemos creado SearchOut, la forma más eficaz de buscar información en la web.</p>
        </div>
        <div id="how-work">
        	<h1 style="display: inline;" id="title4">¿<p style="color: #2BBD52; display: inline;">Como</p> funciona?</h1>
        	<p id="text4">Al pulsar "ENTER" nos encargamos de redirigir al usuario directamente a la web elegida. De esta forma, puede ahorrar tiempo y navegar por la web con mayor comodidad.</p>
        </div>
        <div style="text-align: center;">
        <div id="pages">
        	<h2 id="pages-text" style="display:inline;">¿En que <p style="color: #FEBF33; display: inline;">páginas</p> puedo <p style="display: inline; color: #408fec;">buscar</p> ?</h2>
        	<ul>
        ...
        <div style="text-align: center;">
        <div id="comming-soon">
        	<h2 id="comming-soon-text">Próximamente :</h2>
        	<ul>
        		<li class="li-comming-soon">Crear tu propio buscador. (Completado)</li>
                <li class="li-comming-soon">Cambiar el idioma. (Completado)</li>
        		<li class="li-comming-soon">Blog. (Completado)</li>
        		<li class="li-comming-soon">Diseño adaptado a celulares. (Completado)</li>
        		<li class="li-comming-soon">Sugerencias de autocompletado. (Completado)</li>
        	</ul>
        </div>
        </div>
        </div>
